    ...
    $("#closeButton").click(function () {
        ...
        toastr.options = {
            ...
            k && (t = (t = a) || "Clear itself?", a = t += '<br /><br /><button type="button" class="btn-primary btn clear">Yes</button>',
                ...
                "Have fun storming the castle!"]).length && (g = 0), a = o[g]),
        ...
        }), v.find("#surpriseBtn").length && v.delegate("#surpriseBtn", "click", function () { alert("Surprise! you clicked me. i was toast #" + u + ". You could perform an action here.") }), v.find(".clear").length && v.delegate(".clear", "click", function () { toastr.clear(v, { force: !0 }) }))
    }), $("#clearlasttoast").click(function () { toastr.clear(m) }), $("#cleartoasts").click(function () { toastr.clear() })
});